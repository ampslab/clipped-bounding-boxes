...
// This is the original hilbert.h (Author: Doug Moore), slightly modified
// by Norbert Beckmann, only concerning the names of the integer types.
// Modifications adapt to the RSTree system's standard types and are labeled
// "/*** *:".

/*** *: extra include for the use of the RST system's standard types: ***/
#include "RSTStdTypes.h"

/* define the bitmask_t type as an integer of sufficient size */
/*** *: originally:  typedef unsigned long long bitmask_t; ***/
typedef Rulint  bitmask_t;
/* define the halfmask_t type as an integer of 1/2 the size of bitmask_t */
/*** *: originally:  typedef unsigned long halfmask_t; ***/
typedef Ruint  halfmask_t;
